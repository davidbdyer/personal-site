<?php require_once './partials/config_session.inc.php'; ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
			...
			<section class="introduction" aria-label="introduction">
				...
				<p>I am a Full Stack Developer knowledgeable in CSS/SASS, Javascript, HTML, PHP, SQL, Nodejs, and Java. I am brilliant when it comes to technology and learn new tech quickly. I am passionate about crafting intuitive, enjoyable user experiences for everyone, including those with disabilities. I have a solid understanding of UX/UI and visual design principles and experience using technology to create solutions for problems.</p>
