const portfolioData = [
	{
		...
		description: 'Signup form for the Pray Up newsletter, which I designed and implemented for Pray Up Ministries.',
		date: 'September 2023',
	...
	},
	{
		...
		date: 'April 2023',
		siteUrl: 'https://www.daviddyer.me/portfolio-sites/hangman/',
		imgUrl: 'images/site-thumbs/hangman.png',
		imgAlt: 'hangman game',
		aria: 'hangman--tab',
	...
	{
		title: 'Yelp Camp',
		description: 'Web App for finding, rating, and reviewing campgrounds. The site is dynamically generated using EJS, EJS Mate, and MongoDB. Connect-flash is used for error and success messages. User input is validated using Joi, sanitize-html, and express-mongo-sanitize. Helmet is used for added security. User logins are implemented using passport and express-session for session data. Cloudinary is used for image storage and manipulations. Mapbox is used for custom interactive maps. This based on a project from <a href="https://www.udemy.com/share/101W923@0AHFLcM1tVaGQceAH4TxemyQ-r5T4YPxJg1AW3GjmKdmgXhCa0JxOIeAvNWLXTZ6/">Colt Steele Web Developer Bootcamp</a>. I customized it to work with a proxy.',
		date: 'September 2021',
